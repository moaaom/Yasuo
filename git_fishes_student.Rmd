...
We can see the p-values from permutation test are similar with the p-values from t-test, which confirms the authenticity of each other. Only humbug and lemon species have significant difference between control and CO2 groups, which means CO2 can affect the activity of the two species.
