...
#The left side shows all changes in my repo this time, which are waiting me to push them. The right side shows the content of my Rmarkdown file, in which the left line number shows the changed codes in the previous version and highlighted in red; the right line number shows the new codes this time and highlighted in green.
```
